...
public class TelegramMessageService {
    ...
    public String getHelpMessage() {
        return "ℹ️ <b>How to Use Resume Career Assistant</b>\n\n" +
                ...
                "• /analyze - Upload a resume (PDF, DOCX, DOC or TXT) to analyze\n" +
                ...
                "1. Send /analyze and upload your resume (PDF, DOCX, DOC or TXT).\n" +
    ...
    /**
     * Keyboard shown while the bot is mid-flow and waiting on a specific input
     * (e.g. waiting for a resume PDF, or waiting for a job description).
     *
     * Deliberately does NOT include "📄 Analyze Resume" / "📊 Compare Resumes" /
     * other menu-navigation buttons: those buttons previously stayed visible
     * (left over from the Main Menu keyboard) while the bot was waiting for the
     * job description, so a stray tap on the still-visible "📄 Analyze Resume"
     * button would re-trigger the analyze flow and appear to reset the
     * conversation back to the resume-upload step instead of accepting the JD.
     */
    public Map<String, Object> getAwaitingInputKeyboard() {
        return Map.of(
                "keyboard", List.of(
